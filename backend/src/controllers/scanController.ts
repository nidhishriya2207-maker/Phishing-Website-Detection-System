...
export const getUrlReport = async (req: Request, res: Response): Promise<void> => {
...
export const getDomainDetails = async (req: Request, res: Response): Promise<void> => {
...
export const triggerRetrain = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const getRetrainHistory = async (req: Request, res: Response): Promise<void> => {
  try {
    const historyPath = path.join(process.cwd(), 'src', 'utils', 'retrain_history.json');
    let history: any[] = [];
    if (fs.existsSync(historyPath)) {
